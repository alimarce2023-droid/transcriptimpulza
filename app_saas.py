...
# Motor de transcripción (solo si hay un archivo nuevo)
if file_path:
...
# Sección de visualización y traducción (independiente del procesamiento de audio)
if st.session_state.texto_transcrito:
    ...
    # Selector de idioma para traducir el texto ya existente
